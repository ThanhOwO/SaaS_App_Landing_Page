        ...
        <div className="container">
          ...
          >
            {features.map(({ id, icon, caption, title, text, button }) => (
              <div
                key={id}
                className="relative z-2 md:px-10 md:pb-10 pb-5 px-5 flex-50 max-md:g7 max-md:border-2 max-md:border-s3
            ...
            <ul className="relative flex justify-around flex-grow px-[5%] border-2 border-3s rounded-7xl max-md:hidden">
